		...
		<div class="col-md-12">
			<center>
				<div class="card" style="width: 18rem;">
					<img width="150px" align="center" class="img-fluid img-thumbnail img" src="../admin/foto/<?php echo $siswa['gambar']; ?>">
					<div class="card-body">
						<h6 class="card-title" align="center"><?php echo $siswa['nama_siswa']; ?></h6>
						<hr>
