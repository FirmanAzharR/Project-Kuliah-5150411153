				...
				<center>
					<div style="border-radius: 0px; width: 200px;margin-top:20px;border:2px #007BFF solid;background-color: #EFEEEE" class="card" >
						<div align="center" style="padding-top:25px;">
							<img width="130px" align="center" class="img-fluid img-thumbnail" src="../admin/foto/<?php echo $siswa['gambar']; ?>">
						</div>
						<div style="padding-bottom: 20px;margin-top: 10px ">
							<div class="card-text" style="color: #535357;font-weight: bold;text-align: center;font-size: 13px"><?php echo $siswa['nama_siswa'] ?>
						</div>
						<div style="color: #535357;font-weight: bold;text-align: center;;font-size: 13px"><?php echo $siswa['nama_kelas'] ?> <?php echo $siswa['nama_jurusan'] ?> / <?php echo $siswa['semester'] ?> </div>
						<div style="color: #535357;font-weight: bold;text-align: center;;font-size: 13px"><?php echo $siswa['NISS'] ?></div>
						</div>
				</div>
			</center>
			<li>
