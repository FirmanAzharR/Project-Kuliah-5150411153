...
<div style="padding: 25px" class="animated fadeIn" id="input" name="input">
	<div class="row">
		<div class="col-md-4" style="border-right: 1px #ddd solid">
			<h6 style="font-size: 25px;margin-top: 20px">Transkrip Nilai (Semester 1)</h6>
		</div>
		<div class="col-md-4" style="border-right: 1px #ddd solid">
			<?php error_reporting(0); ?>
			<?php $id=$_GET['idn']; ?>
			<?php $transkrip=$data->select_nilai_transkrip($id); ?>
			<div>
		...
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-6"><button onclick="back()" class="btn btn-info btn-sm" style="float: right"><i class="fa fa-book"></i>&nbsp;&nbsp;&nbsp;&nbsp;Data Nilai</button><a href="index.php?halaman=detailnilai2&idn=<?php echo $id ?>" class="btn btn-info btn-sm" style="float: right;margin-top: 5px"><i class="fa fa-eye"></i>&nbsp;&nbsp;Semester 2</a></div>
			</div>
