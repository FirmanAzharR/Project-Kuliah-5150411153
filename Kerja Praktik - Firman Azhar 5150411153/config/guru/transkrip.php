	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-6"><a href="index.php?halaman=transkrip2&id=<?php echo $id ?>" class="btn btn-info btn-sm" style="float: right;margin-top: 5px"><i class="fa fa-eye"></i>&nbsp;&nbsp;Semester 2</a></div>
			</div>
