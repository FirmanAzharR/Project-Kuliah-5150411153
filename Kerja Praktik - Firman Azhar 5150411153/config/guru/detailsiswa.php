<div style="padding: 20px" class="animated fadeIn">
	...
	<?php $akademik=$data->one_select_akademik_siswa($_GET['id']) ?>
	<h4>Detail Siswa</h4>
	<hr>
	<div class="row">
		<div class="col-md-4" style="border-right: 1px #ddd solid">
			<center><div class="card" style="width: 18rem;margin-bottom: 30px">
				...
				<div class="card-body">
					...
					<hr>
					<h6 class="card-title" align="center"><?php echo $akademik['NISS']; ?></h6>
				</div>
			</div>
		</center>
	</div>
