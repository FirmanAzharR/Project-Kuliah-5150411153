...
<?php 
$data = mysqli_query($koneksi,"SELECT*FROM admin WHERE id_admin='1'");
$profil = $data->fetch_assoc();
//echo "<pre>";
//print_r($profil);
//echo "</pre>";
?>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="card card-avatar">
				<center><img src="../assets/img/user.png" class="img-circle card-img-top img-fluid"></center>
				<div class="card-body">
					<hr>
