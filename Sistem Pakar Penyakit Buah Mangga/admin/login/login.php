			...
			<div class="card-body">
				...
				<form method="post" action="login/proses_login.php">
					<div class="input-group mb-3">
						...
						<input type="text" name="username" id="username" class="form-control" placeholder="Email" aria-label="Username" aria-describedby="basic-addon1" autocomplete="off" required>
					</div>
					<div>
						<div class="input-group mb-3">
							<div class="input-group-prepend">
...
<!-- 						<div class="row">
							<div class="col-md-8">
								<div class="input-group mb-3">
									...
									<input  maxlength="4" type="text" name="captcha" class="form-control" placeholder="Input Captcha" aria-label="Input Captcha" aria-describedby="basic-addon1" required autocomplete="off">
								</div>
							</div>
							<div class="col-md-4">
