...
<div style="padding: 25px" class="animated fadeIn" id="show">
	<?php $select=$data->select_pegawai($_SESSION['pegawai']); ?>
	<div class="row">
		<div class="col-md-4">
			<div class="card card-avatar">
				<center><img src="../../pegawai_img/<?php echo $select['foto'] ?>" class="img-circle card-img-top img-fluid"></center>
				<div class="card-body">
					<hr>
			...
			<table class="table table-hover table-responsive" style="margin-left: 10px">
				<tbody style="opacity: 0.7;">	
					<tr>
						...
						<td width="530px"><?php echo $select['nama_pegawai'] ?><input type="hidden" name="id" value="<?php echo $select['id']; ?>"></td>
					</tr>
					<tr>
