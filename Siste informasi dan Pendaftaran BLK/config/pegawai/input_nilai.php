<div style="margin-left: 15px;margin-right: 15px">
	<div class="row">
		<div class="col-md-6">
			<h4 id="judul">Input Nilai Wawancara</h4>
		</div>
		<div class="col-md-6">
			<a href="index.php?halaman=editnilai" class="btn btn-sm btn-primary" style="float: right"><i class="fa fa-edit"></i>&nbsp;Edit Nilai Wawancara</a>
		</div>
	</div>
		...
		<form method="post">
			<table class="table table-bordered table-striped table-hover" id="myTable">
				...
				<tbody>
					...
					<?php $peserta=$data->tampil_peserta_input_wawancara(); ?>		
					<?php foreach ($peserta as $key => $value): ?>
						<tr>
							...
							<td style="text-align: center; width: 30px"><input type="number" name="nilai[]" class="form-control" value="" required></td>
						</tr>
					<?php endforeach ?>
				</tbody>
			</table>
