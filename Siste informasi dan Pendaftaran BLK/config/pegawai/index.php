	...
	<div class="wrapper print">
		...
		<nav id="sidebar" class="print">
			...
			<ul class="list-unstyled components">
				...
				<li>
					<a href="index.php?halaman=daftarpeserta"><i class="fa fa-bell"></i>&nbsp;&nbsp;Tanggal Wawancara</a>
				</li>
				<li>
					<a href="index.php?halaman=inputnilai"><i class="fa fa-book"></i>&nbsp;&nbsp;Input Nilai Wawancara</a>
				</li>
				<li>
					<a href="index.php?halaman=daftarnilai"><i class="fa fa-book"></i>&nbsp;&nbsp;Daftar Nilai Peserta</a>
				</li>
				<li>
					<a href="index.php?halaman=sertifikat"><i class="fa fa-book"></i>&nbsp;&nbsp;Sertifikat</a>
				</li>
			</ul>
		</nav>
	</div>
		...
		<div id="content">
			...
			<div style="margin: 30px;padding: 15px;">
				...
				if (isset($_GET['halaman'])) {
					...
					elseif($_GET['halaman']=="daftarpeserta"){
						include 'daftar_peserta.php';
					}
					elseif($_GET['halaman']=="daftarnilai"){
						include 'daftar_nilai.php';
					}
					elseif($_GET['halaman']=="inputnilai"){
						include 'input_nilai.php';
					}
					elseif($_GET['halaman']=="editnilai"){
						include 'edit_nilai.php';
					}
					elseif($_GET['halaman']=="edittanggal"){
						include 'edit_tanggal.php';
					}
					elseif($_GET['halaman']=="sertifikat"){
						include 'sertifikat.php';
					}
					elseif($_GET['halaman']=="cetaklulus"){
						include 'cetak_lulus.php';
					}
					elseif($_GET['halaman']=="statuscetak"){
						include 'status_cetak.php';
					}
