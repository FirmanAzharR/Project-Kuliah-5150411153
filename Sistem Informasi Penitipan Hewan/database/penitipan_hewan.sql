...
MySQL - 5.5.5-10.4.13-MariaDB : Database - penitipan_hewan
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`penitipan_hewan` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `admin`(`id_admin`,`nama`,`no_telp`,`email`,`password`) values (1,'evik','083123456789','admin@gmail.com','123');
...
insert  into `detail_transaksi`(`id_detail`,`id_transaksi`,`id_kategori`,`id_jenis`,`makanan`,`ukuran_hewan`,`obat`,`vaksin`,`bayar`) values (25,22,1,1,1,0,0,0,30000),(26,22,1,4,1,0,0,0,30000),(28,23,1,2,1,5,13000,1,228000),(29,24,2,6,2,0,0,0,40000),(30,24,2,8,2,7,25000,6,160000);
...
insert  into `gambar`(`id_gambar`,`id_detail_trans`,`nama_gambar`) values (2,25,'86037842.jpg'),(3,26,'44047402.jpg'),(4,28,'37148766.jpg'),(5,29,'98171801.jpg'),(6,30,'36168273.jpg');
...
insert  into `jenis_hewan`(`id_jenis_hewan`,`id_kategori_hewan`,`nama_jenis_hewan`) values (1,1,'Persia'),(2,1,'Anggora'),(3,1,'Siam'),(4,1,'Kampung'),(5,1,'Ragoail'),(6,2,'Pompom'),(7,2,'Pudel'),(8,2,'Cinuahua'),(9,2,'Beagie'),(10,2,'Shitzu'),(11,2,'Chow-chow'),(12,2,'Siberian husky');
...
insert  into `kategori_hewan`(`id_kategori_hewan`,`nama_kategori_hewan`,`harga`) values (1,'Kucing',25000),(2,'Anjing',30000);
...
insert  into `makanan`(`id_makanan`,`id_kategori_hewan`,`keterangan`,`harga`) values (1,1,'Dari PS',5000),(2,2,'Dari PS',10000);
...
insert  into `obat_peliharaan`(`id_obat`,`id_hewan`,`nama_obat`,`harga`) values (1,1,'Anti Bakteri',3000),(2,1,'Anti Kutu',5000),(3,1,'Anti Jamur',5000),(4,2,'Anti Bakteri',5000),(5,2,'Anti Kutu',10000),(6,2,'Anti Jamur',10000);
...
insert  into `stok_kandang`(`jumlah_stok`,`total_stok`) values (11,40);
...
insert  into `transaksi`(`id_transaksi`,`id_user`,`tgl_titip`,`tgl_ambil`,`status`,`status_ambil`,`kode_trans`) values (22,1,'2020-07-20','2020-07-21',0,0,'TR003'),(23,1,'2020-07-20','2020-07-21',2,0,'TR005'),(24,1,'2020-07-20','2020-07-21',1,0,'TR007');
...
insert  into `ukuran_hewan`(`id_ukuran`,`id_peliharaan`,`nama_ukuran`,`harga_ukuran`) values (4,1,'S (Small)',30000),(5,1,'M (Medium)',45000),(6,1,'L (Large)',60000),(7,2,'S (Small)',45000),(8,2,'M (Medium)',65000),(9,2,'L (Large)',90000);
...
insert  into `user`(`id_user`,`nama`,`alamat`,`no_telp`,`username`,`password`,`email`) values (1,'Firman Azhar Riyadi','Jl. Purbaya No.109, Warak Kidul, Sumberadi, Mlati, Sleman, Yogyakarta','083122494952','far','123','firmanazharr@gmail.com'),(2,'Frengky','London stret','0972611771','fucek','123','frengkyman@gmail.com'),(4,'Demon Hunter','Lawn Of Dawns','083122494952','alucard','123','demon@gmail.com');
...
insert  into `vaksin`(`id_vaksin`,`id_kategori_hewan`,`nama_vaksin`,`harga`) values (1,1,'Vaksin Feio 3',140000),(2,1,'Vaksin Feio 4',150000),(3,2,'DHP',135000),(4,2,'DHPPi',145000),(5,2,'DHPPiLR',170000),(6,2,'Rabies',50000);
