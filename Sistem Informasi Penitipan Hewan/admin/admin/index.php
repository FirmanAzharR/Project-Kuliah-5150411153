...
<body>
  <div class="d-flex" id="wrapper">
    ...
    <div style="border-right:2px solid  #ffc400;" id="sidebar-wrapper">
      <div class="sidebar-heading" align="center" style="font-family: Forte">Griya Satwa</div>
      <div class="list-group list-group-flush">
        ...
        <a href="index.php?halaman=menu1" class="list-group-item list-group-item-action menu"><i class="fa fa-tasks"></i>&nbsp;&nbsp;Data Master</a>
        <a href="index.php?halaman=menu2" class="list-group-item list-group-item-action menu"><i class="fa fa-database"></i>&nbsp;&nbsp;Data Transaksi</a>
        ...
        <a href="index.php?halaman=menu3" class="list-group-item list-group-item-action menu"><i class="fa fa-graduation-cap"></i>&nbsp;Data User</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
