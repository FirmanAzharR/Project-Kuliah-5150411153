...
if ($input==1) { 
	...
	<div class="form-group">
		<select class="form-control" id="jns" style="color: #5D5D5D;">
			<option selected value="0" style="font-weight: bold">Pilih Jenis Kucing</option>
	...
	<div id="pilih_paket">
		...
		<div class="form-group">
			<select class="form-control" id="ukuran" name="ukuran" style="color: #5D5D5D;">
				<option selected id_ukuran='0' value="0" style="font-weight: bold">Pilih Ukuran Kucing</option>
