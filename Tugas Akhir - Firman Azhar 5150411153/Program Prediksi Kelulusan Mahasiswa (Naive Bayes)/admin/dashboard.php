...
<div style="margin-top: 15px;margin-left: 15px;margin-right: 15px">
	<h3>Prediksi Kelulusan Mahasiswa Teknik Informatika UTY</h3>
	<hr style="border: 1px solid #FFC400">
	<div style="text-align: justify;">
		Prediksi kelulusan Mahasiswa TI UTY ini dibuat menggunakan metode Naive Bayes Classifier. Algoritma Naive Bayes merupakan sebuah metoda klasifikasi menggunakan metode probabilitas dan statistik. Algoritma Naive Bayes memprediksi peluang di masa depan berdasarkan pengalaman di masa sebelumnya sehingga dikenal sebagai Teorema Bayes.
	</div>
	<hr>
	<div class="row">
		<div class="col-md-3">
				...
				<div class="card-body">
					<center>
						<div class="icon">
							...
							<hr>
							Jumlah Data Peserta : <br>
							<h6 style=""><?php echo $jml=$data->jumlah_data(); ?>&nbsp;Record Data</h6>
						</div>
					</center>
				</div>
			</div>
