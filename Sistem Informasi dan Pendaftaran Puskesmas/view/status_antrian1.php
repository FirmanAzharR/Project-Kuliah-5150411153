...
include '../config/koneksi.php';
	...
	$tujuan = $_POST['tujuan'];
	$data = mysqli_query($koneksi,"SELECT no_rm,nama_pasien FROM pasien_berobat WHERE no_antrian ='$antrian' and tujuan='$tujuan' and tanggal_berobat=CURDATE()");
		...
		<div class="col-xs-12 col-sm-4 col-md-4">
			<div class="panel" id="cek">
				...
				<div class="panel-body">
						<label>Nama Pasien :&nbsp;<?php echo $pasien['nama_pasien']; ?></label><br>
						<label>No RM :&nbsp;<?php echo 'RM00';echo $pasien['no_rm']; ?></label><br>
