            ...
            <table style="line-height:0.6;">
              <tr>
                ...
                <td nowrap align="center">
                  <h style="font-size:8px;">PEMERINTAH KABUPATEN TEMANGGUNG</h><br>
                  <h style="font-size:8px;"><b>DINAS KESEHATAN</b></h> <br>
                  <h style="font-size:8px;"><b>UPT PUSKESMAS BANSARI</b></h> <br>
                  <h style="font-size:6px;">&nbsp;&nbsp;Alamat: Jl.Raya Bansari-Mojosari, Bansar, Temanggung, Telp.  0293 (596925)</h>&nbsp;
                </td>
                <td>
              ...
              <tr>
                <td colspan="3" align="center">
                  <table class="isi" style="font-size:8px;">
                    <tr>
                      <td class="dalem" style="border:0;">Nama</td>
                      <td class="dalem">:</td>
                      <td class="dalem"> <?php echo $nama ?></td>
                      <td class="dalem"></td>
                      <td class="dalem"></td>
                      <td class="dalem"></td>
                      <td class="dalem"></td>
                    ...
                    <tr>
                      <td class="dalem" style="border:0;">Nomor</td>
                      <td class="dalem">:</td>
                      <td class="dalem">RM00<?php echo $nomorrekmed ?></td>
                      <td class="dalem"></td>
                      <td class="dalem"></td>
                      <td class="dalem"></td>
                      <td class="dalem"></td>
