 <?php 
 session_start();
 if($_SESSION['status']!="login"||$_SESSION['level']!=4){
 	...
 	<div id="wrapper">
 		...
 		<nav class="navbar navbar-default navbar-fixed-top">
 			...
 			<div class="container-fluid">
 				<div class="brand">
 					<span style="font-weight: bold;font-family: Arial;font-size: 15px">Admin Puskesmas Bansari</span>
 				</div>	
 				<div id="navbar-menu">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="index.php?halaman=pasien" id="dt-pasien"><i class="lnr lnr-list"></i> <span>Data Pasien</span></a></li>	
...
<!-- 						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a id="pengaturan" href="index.php?halaman=pengaturan" class="">Pengaturan Antrian</a></li>
									<li><a id="umum" href="index.php?halaman=bp_umum" class="">BP Umum</a></li>
									<li><a id="gigi" href="index.php?halaman=bp_gigi" class="">BP Gigi</a></li>
								</ul>
							</div>
						</li> -->
						<!--<li><a href="index.php?halaman=akun" id="dt-akun"><i class="lnr lnr-user"></i> <span>Data Akun</span></a></li>-->
						<li><a href="index.php?halaman=kritik_saran" id="dt-kritik-saran"><i class="lnr lnr-book"></i> <span>Data Kritik & Saran</span></a></li>	
					</ul>
				</nav>
			</div>
		</div>
						...
						<div class="panel-body">
							...
							if (!isset($_GET['halaman'])) {
								...
								elseif ($_GET['halaman']=='bp_gigi') {
									...
									include 'pengaturan_antrian.php';
								...
								elseif ($_GET['halaman']=='kritik_saran') {
